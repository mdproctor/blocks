...
public class ThreadSummaryObserver {
    ...
    private final Consumer<ThreadSummaryUpdatedEvent> summaryEventPublisher;
    ...
    public ThreadSummaryObserver(ContentSummariser<Message, SummaryResult> contentSummariser,
                                 ...
                                 Consumer<ThreadSummaryUpdatedEvent> summaryEventPublisher,
                                 Executor executor) {
    ...
    public void onTerminalMessage(MessageReceivedEvent event) {
    ...
    void summariseThread(UUID channelId, String correlationId,
        ...
        try {
            ...
            summaryEventPublisher.accept(new ThreadSummaryUpdatedEvent(
